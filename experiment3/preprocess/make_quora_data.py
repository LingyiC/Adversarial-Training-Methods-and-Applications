        ...
        if len(line_data) == 3:
            ...
            for t in tokens:
                if t not in dictionary:
                    tmp_case.append(dictionary['UNK'])
                elif t in stopwords:
                    continue
                elif is_number(t):
                    tmp_case.append(dictionary['NUM'])
                else:
                    tmp_case.append(dictionary[t])
...
np.save("../dataset/nltk_xtrain_formal.npy", xtrain)
np.save("../dataset/nltk_ytrain_formal.npy", ytrain)
np.save("../dataset/nltk_ultrain_formal.npy", unlab)
...
np.save("../dataset/nltk_xtrain_mix.npy", xtrain)
np.save("../dataset/nltk_ytrain_mix.npy", ytrain)
np.save("../dataset/nltk_ultrain_mix.npy", unlab)
...
np.save("../dataset/nltk_xval.npy", x_val)
