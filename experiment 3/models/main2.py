...
############
def _add_perturbation(embedded, loss, epsilon):
...
def model_fn(features, labels, mode, params):
    ...
    ##########
        ...
        output_fw1, _1 = lstm_cell_fw(t, dtype=tf.float32, sequence_length=nwords)
        output_bw1, _1 = lstm_cell_bw(t, dtype=tf.float32, sequence_length=nwords)
