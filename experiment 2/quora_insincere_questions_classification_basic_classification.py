# -*- coding: utf-8 -*-
"""Quora Insincere Questions Classification basic classification.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1l1O0tfnhxLlGYJ1UXaMPlmWyoYjzfEe4
"""
...
# ~2 hours to train 
import sys 
sys.path.append('/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification')
...
def load_and_prec():
    train_df = pd.read_csv("/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/train.csv")
    test_df = pd.read_csv("/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/test.csv")
...
def load_glove(word_index):
    EMBEDDING_FILE = '/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/embeddings/glove.840B.300d/glove.840B.300d.txt'
...
def load_fasttext(word_index):    
    EMBEDDING_FILE = '/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/embeddings/wiki-news-300d-1M/wiki-news-300d-1M.vec'
    def get_coefs(word,*arr): return word, np.asarray(arr, dtype='float32')
...
def load_para(word_index):
    EMBEDDING_FILE = '/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/embeddings/paragram_300_sl999/paragram_300_sl999.txt'
    def get_coefs(word,*arr): return word, np.asarray(arr, dtype='float32')
...
def load_fasttext2(word_index): 
  WIKI_NEWS = '/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/embeddings/wiki-news-300d-1M/wiki-news-300d-1M.vec'
...
def load_googlenews(word_index): 
  GoogleNews = '/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/embeddings/GoogleNews-vectors-negative300.bin.gz'
...
# new implementation
infile = open("/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/embeddings/stopwords.txt")
...
sub = pd.read_csv('/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/sample_submission.csv')
sub.prediction = test_meta > 0.33
sub.to_csv("/content/gdrive/My Drive/Final Project/4995 DL/project/basic classification/submission.csv", index=False)
